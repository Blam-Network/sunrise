...
#[axum::debug_handler]
pub async fn get_recent_players(Path((_, _, _, xuid)): Path<(String, String, String, String)>) -> impl IntoResponse {
    let mut recent_players = recent_players {
        _blf: s_blf_chunk_start_of_file::new("halo3 recent players", byte_order_mark::default()),
